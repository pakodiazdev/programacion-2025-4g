...
## Práctica 74 — Descuento por cliente VIP o cupón  

**Archivo:** `p74-descuento-vip-cupon.php`  
...
## Práctica 75 — Producto no disponible  

**Archivo:** `p75-producto-agotado.php`  
...
## Práctica 76 — Acceso con credencial o pase temporal  

**Archivo:** `p76-acceso-con-credencial-o-pase.php`  
...
## Práctica 77 — Alumno no aprobado  

**Archivo:** `p77-no-aprobado.php`  
...
## Práctica 78 — Promoción por mayoreo o membresía  

**Archivo:** `p78-promocion-por-mayoreo-o-membresia.php`  
...
## Práctica 79 — Acceso no autorizado por contraseña  

**Archivo:** `p79-no-autorizado-por-contrasena.php`  
...
## Práctica 80 — Aprobación por examen o proyecto  

**Archivo:** `p80-aprobacion-por-examen-o-proyecto.php`  
...
## Práctica 81 — Empleado no puntual  

**Archivo:** `p81-no-puntual.php`  
...
## Práctica 82 — Envío gratis por monto o cliente premium  

**Archivo:** `p82-envio-gratis-por-monto-o-premium.php`  
...
## Práctica 83 — Paquete no cerrado correctamente  

**Archivo:** `p83-no-cerrado-correctamente.php`  
...
## Práctica 84 — Acceso por usuario o correo registrado  

**Archivo:** `p84-acceso-por-usuario-o-correo.php`  
...
## Práctica 85 — Usuario no registrado  

**Archivo:** `p85-no-registrado.php`  
...
## Práctica 86 — Beca por promedio o deporte  

**Archivo:** `p86-beca-por-promedio-o-deporte.php`  
...
## Práctica 87 — Aspirante sin documentos completos  

**Archivo:** `p87-no-entrego-documentos.php`  
...
## Práctica 88 — Ingreso por cita o ficha  

**Archivo:** `p88-ingreso-por-cita-o-ficha.php`  
...
## Práctica 89 — Equipo sin conexión a red  

**Archivo:** `p89-no-conectado-a-red.php`  
...
## Práctica 90 — Promoción por edad o día especial  

**Archivo:** `p90-promocion-por-edad-o-dia.php`  
...
## Práctica 91 — Curso sin espacios  

**Archivo:** `p91-no-hay-espacios.php`  
...
## Práctica 92 — Entrega por ruta A o ruta B  

**Archivo:** `p92-entrega-por-ruta-a-o-ruta-b.php`  
...
## Práctica 93 — No cumple edad mínima  

**Archivo:** `p93-no-cumple-edad.php`  
...
## Práctica 94 — Recuperación por tarea o examen  

**Archivo:** `p94-recuperacion-por-tarea-o-examen.php`  
...
## Práctica 95 — No es día hábil  

**Archivo:** `p95-no-es-dia-habil.php`  
...
## Práctica 96 — Pago por efectivo o transferencia  

**Archivo:** `p96-pago-por-efectivo-o-transferencia.php`  
...
## Práctica 97 — Pago incompleto  

**Archivo:** `p97-no-pago-completo.php`  
...
## Práctica 98 — Acceso por turno o permiso  

**Archivo:** `p98-acceso-por-turno-o-permiso.php`  
...
## Práctica 99 — Alumno sin uniforme  

**Archivo:** `p99-no-porta-uniforme.php`  
...
## Práctica 100 — Promoción por cupón o puntos  

**Archivo:** `p100-promocion-por-cupon-o-puntos.php`  
...
## Práctica 101 — Cuenta no activa  

**Archivo:** `p101-no-cuenta-activa.php`  
...
## Práctica 102 — Salida por fin de turno o relevo  

**Archivo:** `p102-salida-por-fin-de-turno-o-relevo.php`  
...
## Práctica 103 — Tarea no entregada  

**Archivo:** `p103-no-entrego-tarea.php`  
...
## Práctica 104 — Entrada con boleto o invitación  

**Archivo:** `p104-entrada-con-boleto-o-invitacion.php`  
...
## Práctica 105 — Paquete fuera de peso permitido  

**Archivo:** `p105-no-cumple-peso.php`  
...
## Práctica 106 — Pedido válido por clave o nombre  

**Archivo:** `p106-pedido-valido-por-clave-o-nombre.php`  
...
## Práctica 107 — Cliente no frecuente  

**Archivo:** `p107-no-es-cliente-frecuente.php`  
...
## Práctica 108 — Acceso por PIN o huella  

**Archivo:** `p108-acceso-por-pin-o-huella.php`  
...
## Práctica 109 — Saldo insuficiente  

**Archivo:** `p109-no-hay-fondos.php`  
...
## Práctica 110 — Alerta por temperatura o humo  

**Archivo:** `p110-alerta-por-temperatura-o-humo.php`  
...
## Práctica 111 — Caja no apta por altura  

**Archivo:** `p111-no-cumple-altura.php`  
...
## Práctica 112 — Habitación disponible por reserva o cancelación  

**Archivo:** `p112-habitacion-disponible-por-reserva-o-cancelacion.php`  
...
## Práctica 113 — Reservación no encontrada  

**Archivo:** `p113-no-hay-reservacion.php`  
...
## Práctica 114 — Compra aprobada por saldo o crédito  

**Archivo:** `p114-compra-aprobada-por-saldo-o-credito.php`  
...
## Práctica 115 — Equipo sin batería suficiente  

**Archivo:** `p115-no-cuenta-con-bateria.php`  
...
## Práctica 116 — Acceso por llave o código  

**Archivo:** `p116-acceso-por-llave-o-codigo.php`  
...
## Práctica 117 — Código no válido  

**Archivo:** `p117-no-es-codigo-valido.php`  
